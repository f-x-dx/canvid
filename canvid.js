;(function(root, factory) {
  ...
  function canvid(params) {
    var defaultOptions = {
        ...
        canvasSelector: '.canvid-wrapper > canvas'
      },
      firstPlay = true,
      control = {
        play: function() {
      ...
      el =
        typeof _opts.selector === 'string'
          ? document.querySelector(_opts.selector)
          : _opts.selector
    ...
    function initCanvas() {
      if (_opts.canvasSelector) {
        var canvas = document.querySelector(_opts.canvasSelector)
